...
namespace CardCollectionAPI.Migrations
{
    ...
    [Migration("20250415145707_UpdateUserIdType3")]
    partial class UpdateUserIdType3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CardCollectionAPI.Models.User.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CardCollectionAPI.Models.CardInventory", b =>
                {
                    b.HasOne("CardCollectionAPI.Models.User.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CardCollectionAPI.Models.User.User", "User")
                        .WithMany("CardInventory")
